...
O objetivo deste website é apresentar a solução para o trabalho proposto no módulo de Métodos Matriciais e Análise de Clusters do curso de MBA em Business Analytics e Big Data da FGV (turma Berrini).

Utilize o menu acima para navegar pelo site e visualizar o relatório final.

## Professor
- Rodrigo Togneri (rodrigo.togneri@fgv.br)
