...
df2 <- data.frame(k=integer(), 
                 ...
                 tot.withinss=double(),
                 avg.silwidth=double())
# Calcular a matriz de distâncias que é input para a função cluster.stats.
...
##c) As métricas coletadas indicam que os clusters encontrados são adequados? Justifique.

A única das métricas coletadas que nos permite dizer se os clusters são adequados é a asw. A asw apresenta valor máximo de 0,20, considerando que os clusters são ainda inadequados.